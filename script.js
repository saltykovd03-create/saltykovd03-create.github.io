...
(function () {
  ...
  const LOG = [
    ['07:00', 'деньги: остатки по счетам и кассе сверены', 'ok'],
    ['07:20', 'дебиторка: 14 клиентов должны, 3 просрочены', 'warn'],
    ['09:00', 'заявки: 9 диалогов, 2 горячих менеджеру', 'ok'],
    ['09:40', 'звонки: 2 пропущенных, задачи поставлены', 'warn'],
    ['10:15', 'договоры: 7 сделок проверены, отклонений нет', 'ok'],
    ['11:00', 'реклама: цена клиента по каналам обновлена', 'ok'],
    ['12:30', 'склад: поставка задержана на 9 дней', 'warn'],
    ['14:00', 'встреча: протокол готов, 5 задач', 'ok'],
    ['15:20', 'отзывы: 1 негатив на Картах, ушёл в чат', 'warn'],
    ['19:00', 'сводка дня отправлена руководителю', 'ok'],
  ];
